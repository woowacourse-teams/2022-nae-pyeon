...
class RollingpaperServiceTest {
    ...
    void saveRollingpaperWithAnonymous() {
        assertThatThrownBy(() -> rollingpaperService.createMemberRollingpaper(ROLLINGPAPER_TITLE, teamId, member3Id, memberId))
    ...
    void saveRollingpaperToAnonymous() {
        assertThatThrownBy(() -> rollingpaperService.createMemberRollingpaper(ROLLINGPAPER_TITLE, teamId, memberId, member3Id))
    ...
    void findRollingpapersByTeamId() {
        ...
        final Long rollingpaperId2 =
                rollingpaperService.createTeamRollingpaper(ROLLINGPAPER_TITLE, teamId, member2Id);
        final List<RollingpaperPreviewResponseDto> expected = convertPreviewDto(rollingpaperId1, rollingpaperId2, teamId);
    ...
    private List<RollingpaperPreviewResponseDto> convertPreviewDto(final Long rollingpaperId1,
                                                                   final Long rollingpaperId2,
                                                                   final Long teamId) {
        Rollingpaper rollingpaper1 = rollingpaperRepository.findById(rollingpaperId1).get();
        Rollingpaper rollingpaper2 = rollingpaperRepository.findById(rollingpaperId2).get();
        return List.of(
